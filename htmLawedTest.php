...
function sndUnproc(){
 ...
 f.innerHTML = '<p style="display:none;"><input style="display:none;" type="hidden" name="token" id="token" value="<?php echo $token; ?>" /><input style="display:none;" type="hidden" name="<?php echo htmlspecialchars($_sid, ENT_COMPAT, 'UTF-8'); ?>" id="<?php echo htmlspecialchars($_sid, ENT_COMPAT, 'UTF-8'); ?>" value="' + readCookie('<?php echo htmlspecialchars($_sid, ENT_COMPAT, 'UTF-8'); ?>') + '" /></p>';
